<template>
    <div class="pt-20 sm:pt-16 p-6 sm:ml-64 bg-white dark:bg-purple-900 min-h-screen">
        ...
        <div class="flex flex-wrap justify-between items-center pb-4">
            <!-- Aquí puedes meter filtros o dropdown como slot -->
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th v-for="col in headers" :key="col.key" class="px-6 py-3">{{ col.label }}</th>
            ...
            <tbody>
                <tr v-for="(item, index) in filteredItems" :key="index"
                    ...
                    <td v-for="col in headers" :key="col.key" class="px-6 py-4">{{ item[col.key] }}</td>
                    <td class="px-6 py-4">
...
const props = defineProps({
    headers: Array, // [{ key: 'nombre', label: 'Nombre' }]
    items: Array // [{ nombre: '', descripcion: '', ... }]
});
